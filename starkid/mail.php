...
if (isset($_POST["submit"])) {
    ...
    $body2 .= "御社名 : {$companyname}\n";
    $body2 .= "ご担当者名 : {$username}\n";
    if (!empty($position)) {
        $body2 .= "役職 : {$position}\n";
    }
    $body2 .= "メールアドレス : {$email}\n";
    ...
    if (!empty($design)) {
        $body2 .= "デザイン／仕様等のご提供可能日 : {$design}\n";
    }
    if (!empty($delivery)) {
        $body2 .= "ご希望の納品日 : {$delivery}\n";
    }
    if (!empty($budget)) {
        $body2 .= "ご予算 : {$budget}\n";
    }
    ...
    $body2 .= "zoom : {$zoom}\n";
    if ($zoom == "有") {
        $body2 .= "第一候補日 {$candidate1_1}年 {$candidate1_2}月 {$candidate1_3}日\n";
        $body2 .= "第二候補日 {$candidate2_1}年 {$candidate2_2}月 {$candidate2_3}日\n";
        $body2 .= "第三候補日 {$candidate3_1}年 {$candidate3_2}月 {$candidate3_3}日\n";
    }

    /* 見出し 受け取りメール設定 */

    $to = "contact@star-kid.jp";

    $subject = "[star-kid LP]お問合せがありました";

    $subject2 = "[自動送信]star-kid LPより";
    ...
    // お問い合わせ者受け取り用
    mb_send_mail($to, $subject2, $body, $headers);

    header("Location: " . "https://testup.star-kid.jp/nomura/lp/thanks.html");
    exit;
    /*------------------------------------*/
}
...
<head>
    ...
    <title>STARKID</title>
    <link rel="stylesheet" href="css/reset.min.css" media="print" onload="this.media='all'">
    <link rel="stylesheet" href="css/style.min.css" media="print" onload="this.media='all'">
    <link rel="stylesheet" href="css/first.min.css">
...
<body>
    <header class="head">
        <div class="head__inner">
            <a class="logo head__logo" href="/"><img src="images/svg/logo.svg" alt="starkid" width="120" height="32"></a>
            <div class="cta head-cta">
                <a href="#contact" class="head-cta__item mail">
                    ...
                    <img class="pc" src="images/svg/zoom.svg" alt="zoom対応" width="58" height="50">
                </a>
    ...
    <main class="main">
        <div class="bgc-gray pt100">
            <div class="contact content" id="contact">
                ...
                <form action="nomura/lp/mail.php" class="form" method="POST" name="form">
    ...
    <footer class="footer">
        <div class="footer__inner">
            <div class="footer__body">
                <a class="logo footer__logo" href="/"><img src="images/svg/logo.svg" alt="starkid" width="145" height="50">
                </a>
            ...
            <div class="footer__aboutUs">
                <a href="https://star-kid.jp/" target="_blank">ABOUT US</a>
            </div>
        </div>
